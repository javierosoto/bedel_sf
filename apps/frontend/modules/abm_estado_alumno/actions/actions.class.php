...
/**
 * abm_estado_alumno actions.
 *
 * @package    bedel
 * @subpackage abm_estado_alumno
 * @author     Your name here
 */
class abm_estado_alumnoActions extends sfActions
{
  ...
  public function executeDelete(sfWebRequest $request)
  {
    ...
    $this->redirect('abm_estado_alumno/index');
  }
  ...
  protected function processForm(sfWebRequest $request, sfForm $form)
  {
    ...
    if ($form->isValid())
    {
      ...
      $this->redirect('abm_estado_alumno/edit?id='.$Estadoalumno->getId());
    }
  }
}
