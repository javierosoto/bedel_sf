...
abstract class BaseCarreraPeer
{
    ...
    /** the column name for the nombre_carrera field */
    const NOMBRE_CARRERA = 'carrera.nombre_carrera';
     ...
     * e.g. CarreraPeer::$fieldNames[CarreraPeer::TYPE_PHPNAME][0] = 'Id'
     */
    protected static $fieldNames = array (
        BasePeer::TYPE_PHPNAME => array ('Id', 'NombreCarrera', ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombreCarrera', ),
        BasePeer::TYPE_COLNAME => array (CarreraPeer::ID, CarreraPeer::NOMBRE_CARRERA, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID', 'NOMBRE_CARRERA', ),
        BasePeer::TYPE_FIELDNAME => array ('id', 'nombre_carrera', ),
     ...
     *
     * first dimension keys are the type constants
     * e.g. CarreraPeer::$fieldNames[BasePeer::TYPE_PHPNAME]['Id'] = 0
     */
    protected static $fieldKeys = array (
        BasePeer::TYPE_PHPNAME => array ('Id' => 0, 'NombreCarrera' => 1, ),
        BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombreCarrera' => 1, ),
        BasePeer::TYPE_COLNAME => array (CarreraPeer::ID => 0, CarreraPeer::NOMBRE_CARRERA => 1, ),
        BasePeer::TYPE_RAW_COLNAME => array ('ID' => 0, 'NOMBRE_CARRERA' => 1, ),
        BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre_carrera' => 1, ),
        BasePeer::TYPE_NUM => array (0, 1, )
    );
    ...
    {
        $toNames = CarreraPeer::getFieldNames($toType);
        $key = isset(CarreraPeer::$fieldKeys[$fromType][$name]) ? CarreraPeer::$fieldKeys[$fromType][$name] : null;
        if ($key === null) {
            throw new PropelException("'$name' could not be found in the field names of type '$fromType'. These are: " . print_r(CarreraPeer::$fieldKeys[$fromType], true));
        }
    ...
    {
        if (!array_key_exists($type, CarreraPeer::$fieldNames)) {
            throw new PropelException('Method getFieldNames() expects the parameter $type to be one of the class constants BasePeer::TYPE_PHPNAME, BasePeer::TYPE_STUDLYPHPNAME, BasePeer::TYPE_COLNAME, BasePeer::TYPE_FIELDNAME, BasePeer::TYPE_NUM. ' . $type . ' was given.');
        }

        return CarreraPeer::$fieldNames[$type];
    }
    ...
    public static function addSelectColumns(Criteria $criteria, $alias = null)
    {
        if (null === $alias) {
            ...
            $criteria->addSelectColumn(CarreraPeer::NOMBRE_CARRERA);
        } else {
            $criteria->addSelectColumn($alias . '.id');
            $criteria->addSelectColumn($alias . '.nombre_carrera');
        }
    }
    ...
    public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CarreraPeer::DATABASE_NAME); // Set the correct dbName
    ...
    public static function doSelectStmt(Criteria $criteria, PropelPDO $con = null)
    {
        ...
        $criteria->setDbName(CarreraPeer::DATABASE_NAME);
        // symfony_behaviors behavior
        foreach (sfMixer::getCallables(self::getMixerPreSelectHook(__FUNCTION__)) as $sf_hook)
        {
          call_user_func($sf_hook, 'BaseCarreraPeer', $criteria, $con);
    ...
    public static function removeInstanceFromPool($value)
    {
        if (Propel::isInstancePoolingEnabled() && $value !== null) {
            ...
            unset(CarreraPeer::$instances[$key]);
        }
    ...
    {
        if (Propel::isInstancePoolingEnabled()) {
            if (isset(CarreraPeer::$instances[$key])) {
                return CarreraPeer::$instances[$key];
            }
        }
    ...
    public static function clearInstancePool($and_clear_all_references = false)
    {
      ...
      {
        foreach (CarreraPeer::$instances as $instance)
        {
          $instance->clearAllReferences(true);
        }
      }
        CarreraPeer::$instances = array();
    }
    ...
    {
        return Propel::getDatabaseMap(CarreraPeer::DATABASE_NAME)->getTable(CarreraPeer::TABLE_NAME);
    }
    ...
    public static function doUpdate($values, PropelPDO $con = null)
    {
        ...
        $selectCriteria = new Criteria(CarreraPeer::DATABASE_NAME);

        if ($values instanceof Criteria) {
            $criteria = clone $values; // rename for clarity

            $comparison = $criteria->getComparison(CarreraPeer::ID);
            $value = $criteria->remove(CarreraPeer::ID);
            if ($value) {
                $selectCriteria->add(CarreraPeer::ID, $value, $comparison);
            } else {
