 ...
 */
abstract class BaseSexo extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    /**
     * The value for the descripcion_sexo field.
     * @var        string
     */
    protected $descripcion_sexo;
    ...
    /**
     * Get the [descripcion_sexo] column value.
     *
     * @return string
     */
    public function getDescripcionSexo()
    {
        return $this->descripcion_sexo;
    }
    ...
    /**
     * Set the value of [descripcion_sexo] column.
     *
     * @param string $v new value
     * @return Sexo The current object (for fluent API support)
     */
    public function setDescripcionSexo($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->descripcion_sexo !== $v) {
            $this->descripcion_sexo = $v;
            $this->modifiedColumns[] = SexoPeer::DESCRIPCION_SEXO;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->descripcion_sexo = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(SexoPeer::DESCRIPCION_SEXO)) {
            $modifiedColumns[':p' . $index++]  = '`descripcion_sexo`';
        }
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`descripcion_sexo`':
                        $stmt->bindValue($identifier, $this->descripcion_sexo, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getDescripcionSexo();
                break;
            default:
                return null;
                break;
    ...
    public function toArray($keyType = BasePeer::TYPE_PHPNAME, $includeLazyLoadColumns = true, $alreadyDumpedObjects = array(), $includeForeignObjects = false)
    {
        ...
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDescripcionSexo(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDescripcionSexo($arr[$keys[1]]);
    }
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(SexoPeer::DESCRIPCION_SEXO)) $criteria->add(SexoPeer::DESCRIPCION_SEXO, $this->descripcion_sexo);
    ...
    {
        $copyObj->setDescripcionSexo($this->getDescripcionSexo());
    ...
    public function setPersonas(PropelCollection $personas, PropelPDO $con = null)
    {
        ...
        $this->personasScheduledForDeletion = unserialize(serialize($personasToDelete));

        foreach ($personasToDelete as $personaRemoved) {
            $personaRemoved->setSexo(null);
        }
     ...
     * @return PropelObjectCollection|Persona[] List of Persona objects
     */
    public function getPersonasJoinTipoDoc($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = PersonaQuery::create(null, $criteria);
