...
abstract class BaseUsuarioPeer
{
    ...
    protected static $fieldNames = array (
        ...
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::ID, UsuarioPeer::USER, UsuarioPeer::PASSWORD, ),
    ...
    protected static $fieldKeys = array (
        ...
        BasePeer::TYPE_COLNAME => array (UsuarioPeer::ID => 0, UsuarioPeer::USER => 1, UsuarioPeer::PASSWORD => 2, ),
    ...
    {
      return array(array('user'), array('password'));
    }
