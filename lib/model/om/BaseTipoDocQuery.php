 ...
 *
 *
 * @method TipoDocQuery orderById($order = Criteria::ASC) Order by the id column
 * @method TipoDocQuery orderByDescripcion($order = Criteria::ASC) Order by the descripcion column
 *
 * @method TipoDocQuery groupById() Group by the id column
 * @method TipoDocQuery groupByDescripcion() Group by the descripcion column
 *
 ...
 *
 * @method TipoDocQuery leftJoinPersona($relationAlias = null) Adds a LEFT JOIN clause to the query using the Persona relation
 * @method TipoDocQuery rightJoinPersona($relationAlias = null) Adds a RIGHT JOIN clause to the query using the Persona relation
 * @method TipoDocQuery innerJoinPersona($relationAlias = null) Adds a INNER JOIN clause to the query using the Persona relation
 *
 ...
 *
 * @method TipoDoc findOneByDescripcion(string $descripcion) Return the first TipoDoc filtered by the descripcion column
 *
 * @method array findById(int $id) Return TipoDoc objects filtered by the id column
 * @method array findByDescripcion(string $descripcion) Return TipoDoc objects filtered by the descripcion column
 *
...
abstract class BaseTipoDocQuery extends ModelCriteria
{
    ...
    {
        $sql = 'SELECT `id`, `descripcion` FROM `tipo_doc` WHERE `id` = :p0';
        try {
    ...
    public function filterByPrimaryKey($key)
    {
        ...
        return $this->addUsingAlias(TipoDocPeer::ID, $key, Criteria::EQUAL);
    }
    ...
    public function filterByPrimaryKeys($keys)
    {
        ...
        return $this->addUsingAlias(TipoDocPeer::ID, $keys, Criteria::IN);
    }
    ...
    public function filterById($id = null, $comparison = null)
    {
        if (is_array($id)) {
            $useMinMax = false;
            if (isset($id['min'])) {
                $this->addUsingAlias(TipoDocPeer::ID, $id['min'], Criteria::GREATER_EQUAL);
                $useMinMax = true;
            }
            if (isset($id['max'])) {
                $this->addUsingAlias(TipoDocPeer::ID, $id['max'], Criteria::LESS_EQUAL);
                $useMinMax = true;
            }
            if ($useMinMax) {
                return $this;
        ...
        return $this->addUsingAlias(TipoDocPeer::ID, $id, $comparison);
    }
    ...
    public function filterByDescripcion($descripcion = null, $comparison = null)
    {
        ...
        return $this->addUsingAlias(TipoDocPeer::DESCRIPCION, $descripcion, $comparison);
    }
    ...
    public function filterByPersona($persona, $comparison = null)
    {
        if ($persona instanceof Persona) {
            return $this
                ->addUsingAlias(TipoDocPeer::ID, $persona->getTipoDocId(), $comparison);
    ...
    {
        if ($tipoDoc) {
            $this->addUsingAlias(TipoDocPeer::ID, $tipoDoc->getId(), Criteria::NOT_EQUAL);
        }
