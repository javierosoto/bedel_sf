...
/**
 * Base class that represents a row from the 'profesor' table.
 *
 *
 *
...
abstract class BaseProfesor extends BaseObject implements Persistent
{
     ...
     * @return Profesor The current object (for fluent API support)
     */
    ...
    public function setCargoId($v)
    {
        ...
        if ($this->cargo_id !== $v) {
            $this->cargo_id = $v;
            $this->modifiedColumns[] = ProfesorPeer::CARGO_ID;
        }
    ...
    public function setPersonaId($v)
    {
        ...
        if ($this->persona_id !== $v) {
            $this->persona_id = $v;
            $this->modifiedColumns[] = ProfesorPeer::PERSONA_ID;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 3; // 3 = ProfesorPeer::NUM_HYDRATE_COLUMNS.
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = ProfesorPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = ProfesorQuery::create()
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            if ($ret) {
                ...
                ProfesorPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(ProfesorPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(ProfesorPeer::CARGO_ID)) {
            $modifiedColumns[':p' . $index++]  = '`cargo_id`';
        }
        if ($this->isColumnModified(ProfesorPeer::PERSONA_ID)) {
            $modifiedColumns[':p' . $index++]  = '`persona_id`';
        }

        $sql = sprintf(
            'INSERT INTO `profesor` (%s) VALUES (%s)',
    ...
    {
        if (isset($alreadyDumpedObjects['Profesor'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Profesor'][$this->getPrimaryKey()] = true;
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(ProfesorPeer::CARGO_ID)) $criteria->add(ProfesorPeer::CARGO_ID, $this->cargo_id);
        if ($this->isColumnModified(ProfesorPeer::PERSONA_ID)) $criteria->add(ProfesorPeer::PERSONA_ID, $this->persona_id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Profesor (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Profesor Clone of current object.
     * @throws PropelException
     */
    ...
    public function getPersona(PropelPDO $con = null, $doQuery = true)
    {
        if ($this->aPersona === null && ($this->persona_id !== null) && $doQuery) {
            ...
            /* The following can be used additionally to
                ...
                undesirable since it could result in an only partially populated collection
                in the referenced object.
                $this->aPersona->addProfesors($this);
             */
        }
     ...
     * If this Profesor is new, it will return
    ...
    public function setComisions(PropelCollection $comisions, PropelPDO $con = null)
    {
        ...
        foreach ($comisionsToDelete as $comisionRemoved) {
            $comisionRemoved->setProfesor(null);
        }
    ...
    {
        return (string) $this->exportTo(ProfesorPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseProfesor:' . $name))
        {
