...
/**
 * Base class that represents a row from the 'aula' table.
 *
 *
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseAula extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    ...
    /**
     * The value for the descripcion_aula field.
     * @var        string
     */
    protected $descripcion_aula;
    ...
    /**
     * Get the [descripcion_aula] column value.
     *
     * @return string
     */
    public function getDescripcionAula()
    {
        return $this->descripcion_aula;
    }
     ...
     * @return Aula The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = AulaPeer::ID;
        }
    ...
    /**
     * Set the value of [descripcion_aula] column.
     *
     * @param string $v new value
     * @return Aula The current object (for fluent API support)
     */
    public function setDescripcionAula($v)
    {
        if ($v !== null && is_numeric($v)) {
            $v = (string) $v;
        }

        if ($this->descripcion_aula !== $v) {
            $this->descripcion_aula = $v;
            $this->modifiedColumns[] = AulaPeer::DESCRIPCION_AULA;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            $this->descripcion_aula = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
            $this->resetModified();
            ...
            return $startcol + 2; // 2 = AulaPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating Aula object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = AulaPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        if ($con === null) {
            $con = Propel::getConnection(AulaPeer::DATABASE_NAME, Propel::CONNECTION_WRITE);
        }

        $con->beginTransaction();
        try {
            $deleteQuery = AulaQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseAula:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseAula:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseAula:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseAula:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                AulaPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        $this->modifiedColumns[] = AulaPeer::ID;
        if (null !== $this->id) {
            throw new PropelException('Cannot insert a value for auto-increment primary key (' . AulaPeer::ID . ')');
        }

         // check the columns in natural order for more readable SQL queries
        if ($this->isColumnModified(AulaPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(AulaPeer::DESCRIPCION_AULA)) {
            $modifiedColumns[':p' . $index++]  = '`descripcion_aula`';
        }

        $sql = sprintf(
            'INSERT INTO `aula` (%s) VALUES (%s)',
            ...
            foreach ($modifiedColumns as $identifier => $columnName) {
                switch ($columnName) {
                    case '`id`':
                        ...
                        break;
                    case '`descripcion_aula`':
                        $stmt->bindValue($identifier, $this->descripcion_aula, PDO::PARAM_STR);
                        break;
                }
            }
            $stmt->execute();
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = AulaPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = AulaPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    public function getByPosition($pos)
    {
        switch ($pos) {
            case 0:
                ...
                break;
            case 1:
                return $this->getDescripcionAula();
                break;
            default:
                return null;
                break;
    ...
    {
        if (isset($alreadyDumpedObjects['Aula'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['Aula'][$this->getPrimaryKey()] = true;
        $keys = AulaPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
            $keys[1] => $this->getDescripcionAula(),
        );
    ...
    public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
    {
        ...
        if (array_key_exists($keys[1], $arr)) $this->setDescripcionAula($arr[$keys[1]]);
    }
    ...
    {
        $criteria = new Criteria(AulaPeer::DATABASE_NAME);

        if ($this->isColumnModified(AulaPeer::ID)) $criteria->add(AulaPeer::ID, $this->id);
        if ($this->isColumnModified(AulaPeer::DESCRIPCION_AULA)) $criteria->add(AulaPeer::DESCRIPCION_AULA, $this->descripcion_aula);
    ...
    {
        $criteria = new Criteria(AulaPeer::DATABASE_NAME);
        $criteria->add(AulaPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of Aula (or compatible) type.
    ...
    {
        $copyObj->setDescripcionAula($this->getDescripcionAula());
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return Aula Clone of current object.
     * @throws PropelException
     */
     ...
     * If this Aula is new, it will return
     ...
     * Otherwise if this Aula is new, it will return
     * an empty collection; or if this Aula has previously
     * been saved, it will retrieve related Comisions from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in Aula.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Comision[] List of Comision objects
     */
    public function getComisionsJoinMateria($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = ComisionQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(AulaPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseAula:' . $name))
        {
