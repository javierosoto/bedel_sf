...
/**
 * Base class that represents a row from the 'estado_alumno' table.
 *
 *
 *
 * @package    propel.generator.lib.model.om
 */
abstract class BaseEstadoAlumno extends BaseObject implements Persistent
{
    /**
     * Peer class name
     */
    const PEER = 'EstadoAlumnoPeer';

    /**
     * The Peer class.
     * Instance provides a convenient way of calling static methods on a class
     * that calling code may not be able to identify.
     * @var        EstadoAlumnoPeer
     */
     ...
     * @return EstadoAlumno The current object (for fluent API support)
     */
    public function setId($v)
    {
        ...
        if ($this->id !== $v) {
            $this->id = $v;
            $this->modifiedColumns[] = EstadoAlumnoPeer::ID;
        }
    ...
    public function setDescripcion($v)
    {
        ...
        if ($this->descripcion !== $v) {
            $this->descripcion = $v;
            $this->modifiedColumns[] = EstadoAlumnoPeer::DESCRIPCION;
        }
    ...
    public function hydrate($row, $startcol = 0, $rehydrate = false)
    {
        try {
            ...
            return $startcol + 2; // 2 = EstadoAlumnoPeer::NUM_HYDRATE_COLUMNS.

        } catch (Exception $e) {
            throw new PropelException("Error populating EstadoAlumno object", $e);
        }
    }
    ...
    public function reload($deep = false, PropelPDO $con = null)
    {
        ...
        $stmt = EstadoAlumnoPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
    ...
    public function delete(PropelPDO $con = null)
    {
        ...
        try {
            $deleteQuery = EstadoAlumnoQuery::create()
                ->filterByPrimaryKey($this->getPrimaryKey());
            $ret = $this->preDelete($con);
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseEstadoAlumno:delete:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postDelete($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseEstadoAlumno:delete:post') as $callable)
                {
    ...
    public function save(PropelPDO $con = null)
    {
        ...
        try {
            ...
            // symfony_behaviors behavior
            foreach (sfMixer::getCallables('BaseEstadoAlumno:save:pre') as $callable)
            {
            ...
            if ($ret) {
                ...
                $this->postSave($con);
                // symfony_behaviors behavior
                foreach (sfMixer::getCallables('BaseEstadoAlumno:save:post') as $callable)
                {
                  call_user_func($callable, $this, $con, $affectedRows);
                }

                EstadoAlumnoPeer::addInstanceToPool($this);
            } else {
                $affectedRows = 0;
            }
            $con->commit();
    ...
    protected function doInsert(PropelPDO $con)
    {
        ...
        if ($this->isColumnModified(EstadoAlumnoPeer::ID)) {
            $modifiedColumns[':p' . $index++]  = '`id`';
        }
        if ($this->isColumnModified(EstadoAlumnoPeer::DESCRIPCION)) {
            $modifiedColumns[':p' . $index++]  = '`descripcion`';
        }

        $sql = sprintf(
            'INSERT INTO `estado_alumno` (%s) VALUES (%s)',
    ...
    protected function doValidate($columns = null)
    {
        if (!$this->alreadyInValidation) {
            ...
            if (($retval = EstadoAlumnoPeer::doValidate($this, $columns)) !== true) {
    ...
    {
        $pos = EstadoAlumnoPeer::translateFieldName($name, $type, BasePeer::TYPE_NUM);
    ...
    {
        if (isset($alreadyDumpedObjects['EstadoAlumno'][$this->getPrimaryKey()])) {
            return '*RECURSION*';
        }
        $alreadyDumpedObjects['EstadoAlumno'][$this->getPrimaryKey()] = true;
        $keys = EstadoAlumnoPeer::getFieldNames($keyType);
        $result = array(
            $keys[0] => $this->getId(),
    ...
    public function buildCriteria()
    {
        ...
        if ($this->isColumnModified(EstadoAlumnoPeer::ID)) $criteria->add(EstadoAlumnoPeer::ID, $this->id);
        if ($this->isColumnModified(EstadoAlumnoPeer::DESCRIPCION)) $criteria->add(EstadoAlumnoPeer::DESCRIPCION, $this->descripcion);
    ...
    {
        $criteria = new Criteria(EstadoAlumnoPeer::DATABASE_NAME);
        $criteria->add(EstadoAlumnoPeer::ID, $this->id);
     ...
     * objects.
     *
     * @param object $copyObj An object of EstadoAlumno (or compatible) type.
     ...
     *
     * @param boolean $deepCopy Whether to also copy all rows that refer (by fkey) to the current row.
     * @return EstadoAlumno Clone of current object.
     * @throws PropelException
     */
     ...
     *
     * @return EstadoAlumnoPeer
     */
    public function getPeer()
    {
        if (self::$peer === null) {
            self::$peer = new EstadoAlumnoPeer();
        }
     ...
     * If this EstadoAlumno is new, it will return
    ...
    public function setAlumnos(PropelCollection $alumnos, PropelPDO $con = null)
    {
        ...
        foreach ($alumnosToDelete as $alumnoRemoved) {
            $alumnoRemoved->setEstadoAlumno(null);
        }
     ...
     * Otherwise if this EstadoAlumno is new, it will return
     * an empty collection; or if this EstadoAlumno has previously
     * been saved, it will retrieve related Alumnos from storage.
     *
     * This method is protected by default in order to keep the public
     * api reasonable.  You can provide public methods for those you
     * actually need in EstadoAlumno.
     *
     * @param Criteria $criteria optional Criteria object to narrow the query
     * @param PropelPDO $con optional connection object
     ...
     * @return PropelObjectCollection|Alumno[] List of Alumno objects
     */
    public function getAlumnosJoinPersona($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
    {
        $query = AlumnoQuery::create(null, $criteria);
    ...
    {
        return (string) $this->exportTo(EstadoAlumnoPeer::DEFAULT_STRING_FORMAT);
    }
    ...
    public function __call($name, $params)
    {
        ...
        // symfony_behaviors behavior
        if ($callable = sfMixer::getCallable('BaseEstadoAlumno:' . $name))
        {
